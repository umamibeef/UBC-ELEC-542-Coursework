...
In order to solve the eigenvalue problem, it will be necessary to reconfigure the matrix Fock equation from:
...
% For this assignment, the STO-2G and STO-3G basis sets will be used which use two and three linear combinations of gaussian functions respectively to approximate atomic orbitals.
