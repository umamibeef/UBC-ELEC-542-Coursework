...
The Hartree-Fock equation implies that the orbital energies can be written as follows:

\begin{align*}
  \hat{F}\psi_n &= \epsilon_n\psi_n \\
  \epsilon_n &= \bra{\psi_n}\hat{F}\ket{\psi_n} \\
  \epsilon_n &= \bra{\psi_n}\hat{H}_{core}\ket{\psi_n} + \sum_{m=1}^{N/2}\bra{\psi_n}2J_m - K_m\ket{\psi_n} \\
\end{align*}
...
$n$    & $1$    & $2$     & $3$     & $4$      & $5$      & $6$      \\\hline
$E_n$  & $0.007629$  & $3.942602o$  & $3.942602$  & $3.942602$  & $7.489690$  & $7.489690$ \\\hline
\end{tabular}
\end{center}
  \caption{The first six orbital energy levels obtained from applying HF to the Helium atom}
...
\end{tabular}
\end{center}
  \caption{The first six orbital energy levels obtained from applying HF to the Hydrogen molecule}
