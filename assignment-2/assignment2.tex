...
\begin{align*}
  E_{o(He)} &= E_{o(H_2)} = \sum_i^2\bra{i}\hat{h}\ket{i} + \frac{1}{2}\sum_i^2\sum_j^2\bra{ij}\ket{ij} \\
  &= \bra{1}\hat{h}\ket{1} + \bra{2}\hat{h}\ket{2} + \frac{1}{2}\left[\bra{11}\ket{11} + \bra{12}\ket{12} + \bra{21}\ket{21} + \bra{22}\ket{22}\right] \\
  &= 2\bra{1}\hat{h}\ket{1} + \bra{11}\ket{11} + \bra{12}\ket{12}
\end{align*}
...
\begin{align*}
  ...
  2\int_{-\infty}^{\infty} \psi_1^\ast(\vec{r}_1) \int_{-\infty}^{\infty} \left|\psi_1(\vec{r}_2)\right|^2\frac{1}{\|\vec{r}_{12}\|}d\vec{r}_2 \psi_1(\vec{r}_1) d\vec{r}_1 \\
  &= 2\int_{-\infty}^{\infty}\left|\psi_1(\vec{r}_1)\right|^2 \left[ -\frac{1}{2}\nabla_1^2 - \frac{2}{\|\vec{r}_{1 A}\|} \right] d\vec{r}_1 + 2\int_{-\infty}^{\infty} \left|\psi_1(\vec{r}_1)\right|^2 \int_{-\infty}^{\infty} \left|\psi_1(\vec{r}_2)\right|^2\frac{1}{\|\vec{r}_{12}\|}d\vec{r}_2 d\vec{r}_1
\end{align*}

\begin{align*}
  E_{o(H_2)} &= 2\int_{-\infty}^{\infty}\psi_1^\ast(\vec{r}_1) \left[ -\frac{1}{2}\nabla_1^2 - \frac{1}{\|\vec{r}_{1 A}\|} - \frac{1}{\|\vec{r}_{1 B}\|} \right] \psi_1(\vec{r}_1) d\vec{r}_1 + 2\int_{-\infty}^{\infty} \psi_1^\ast(\vec{r}_1) \int_{-\infty}^{\infty} \left|\psi_1(\vec{r}_2)\right|^2\frac{1}{\|\vec{r}_{12}\|}d\vec{r}_2 \psi_1(\vec{r}_1) d\vec{r}_1 \\
  &= 2\int_{-\infty}^{\infty} \left|\psi_1(\vec{r}_1)\right|^2 \left[ -\frac{1}{2}\nabla_1^2 - \frac{1}{\|\vec{r}_{1 A}\|} - \frac{1}{\|\vec{r}_{1 B}\|} \right] d\vec{r}_1 + 2\int_{-\infty}^{\infty} \left|\psi_1(\vec{r}_1)\right|^2 \int_{-\infty}^{\infty} \left|\psi_1(\vec{r}_2)\right|^2\frac{1}{\|\vec{r}_{12}\|}d\vec{r}_2 d\vec{r}_1
\end{align*}
